...
public class NormalAndExtraHoursDuringTheWeek {
    ...
    public short daytimeHoursMiddleDates(List<Date> date) {
        ...
        short HoursMiddleDates = (short)(middleDates * 12);
        System.out.println("daytimeHoursMiddleDates middle days: " + HoursMiddleDates);
        return HoursMiddleDates;
    }
    ...
    public short nightHoursMiddleDates(List<Date> date) {
        ...
        short nightHoursMiddleDates = (short)(middleDates * 12);
        System.out.println("nighttimeHours middle days: " + nightHoursMiddleDates);
        return nightHoursMiddleDates;
    }
